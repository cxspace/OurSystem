        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <tr>
                ...
                <th>
                    ...
                    <a href="${pageContext.request.contextPath}/front_learn_route_route_add.action" class="btn btn-info btn-sm btn-icon icon-left">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/front_learn_route_route_detail.action?learnRoute.id=<s:property value="id"></s:property>" class="btn btn-default btn-sm btn-icon icon-left">
