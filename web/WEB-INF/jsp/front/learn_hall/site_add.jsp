...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post" action="${pageContext.request.contextPath}/front_learn_site_add.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">学习站点名</label>

                <div class="col-sm-5">
                    <input type="text" name="learnSite.name" class="form-control" id="field-1" placeholder="请输入学习站点名">
                </div>
            </div>
            ...
            <label class="control-label">站点介绍和链接</label>

            <br><br>

            <textarea placeholder="注意注意！！！编辑器组件面板上有添加链接的功能！！！" id="editor" name="learnSite.content" style="width: 100%;height: 360px;">
