...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
            ...
            <ul id="main-menu" class="main-menu">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/front_our_note_add_list.action">
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post" action="${pageContext.request.contextPath}/front_learn_route_add.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">路线名</label>

                <div class="col-sm-5">
                    <input type="text" name="learnRoute.name" class="form-control" id="field-1" placeholder="请输入路线名">
                </div>
            </div>
