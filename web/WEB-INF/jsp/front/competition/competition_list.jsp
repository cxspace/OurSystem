    ...
    <div class="main-content">
        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/front_competition_competition_detail.action?competition.id=<s:property value="id"></s:property>" class="btn btn-default btn-sm btn-icon icon-left">
        ...
        <script type="text/javascript">
            ...
            function doGoPage(pageNo) {
                document.forms[0].action = "${pageContext.request.contextPath}/front_competition_competition_list.action?pageNo="+pageNo;
