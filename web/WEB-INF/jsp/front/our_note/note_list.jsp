            ...
            <table class="table mail-table">
                ...
                <tr class="unread"><!-- new email class: unread -->
                    ...
                    <td class="col-time">
                        ...
                        <a href="${pageContext.request.contextPath}/front_our_note_note_edit.action?note.id=<s:property value="id"></s:property>" class="btn btn-default btn-sm btn-icon icon-left">
                            <i class="entypo-pencil"></i>
                            编辑笔记
                        </a>
