...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post" action="${pageContext.request.contextPath}/front_our_note_add.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">笔记标题</label>

                <div class="col-sm-5">
                    <input type="text" name="note.name" class="form-control" id="field-1" placeholder="请输入笔记标题">
                </div>
            </div>
            ...
            <label class="control-label">笔记类别</label>
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-5">
                    ...
                    <s:iterator value="noteClassList" status="st">
                        <div class="radio">
                            <label>
                                <input type="radio" name="note.note_class" value="<s:property value="name"></s:property>">
