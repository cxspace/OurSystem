...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post" action="${pageContext.request.contextPath}/front_share_hall_res_addLink.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">资料链接主题</label>

                <div class="col-sm-5">
                    <input type="text" name="resLink.name" class="form-control" id="field-1" placeholder="请输入资料链接主题">
                </div>
            </div>
