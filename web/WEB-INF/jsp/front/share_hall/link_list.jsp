    ...
    <div class="main-content">
        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <tr>
                ...
                <th>
                    <a href="${pageContext.request.contextPath}/front_share_hall_link_add.action" class="btn btn-info btn-sm btn-icon icon-left">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/front_share_hall_link_detail.action?resLink.id=<s:property value="id"></s:property>" class="btn btn-default btn-sm btn-icon icon-left">
        ...
        <script type="text/javascript">
            ...
            function doGoPage(pageNo) {
                document.forms[0].action = "${pageContext.request.contextPath}/front_share_hall_link_list.action?pageNo="+pageNo;
