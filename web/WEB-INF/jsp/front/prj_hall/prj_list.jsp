...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <!-- Mail Body -->
            <div class="mail-body">
                ...
                <div class="mail-header">
                    ...
                    <h3 class="mail-title">
                        项目列表
                        <span class="count">(<s:property value="pageResult.totalCount"></s:property>)</span>
                    </h3>

                    <!-- search -->
                    <form method="post" action="" role="form" class="mail-search">
                        <div class="input-group">
                            <input type="text" class="form-control" value="<s:property value="project.name"/>" name="project.name" placeholder="输入项目名搜索..." />

                            <div class="input-group-addon">
                                <a class="entypo-search" onclick="doPrjSearch()"></a>
                            </div>
                        </div>
                    </form>
                ...
                <table class="table mail-table">
                    ...
                    <tr class="unread"><!-- new email class: unread -->
                        ...
                        <td class="col-options">
                            ...
                            <a href="${pageContext.request.contextPath}/front_prj_hall_prjDoc_doc_list.action?project.id=<s:property value="id"></s:property>">
                                点击查看
                            </a>
                        </td>
                        ...
                        <td class="col-options">
                            ...
                            <a href="${pageContext.request.contextPath}/front_prj_hall_prjTask_task_list.action?project.id=<s:property value="id"></s:property>">
                                点击查看
                            </a>
                        </td>
                ...
                <script type="text/javascript">
                    ...
                    function doGoPage(pageNo) {
                        document.forms[1].action = "${pageContext.request.contextPath}/front_prj_hall_prj_prj_list.action?pageNo="+pageNo;
                        document.forms[1].submit();
                    }

                    function doPrjSearch() {
                        document.forms[0].action = "${pageContext.request.contextPath}/front_prj_hall_prj_prj_search.action";
        ...
        <div class="col-sm-offset-5 col-sm-5">
            ...
            <a href="${pageContext.request.contextPath}/front_prj_hall_prj_prj_list.action" class="btn btn-default">所有项目列表</a>
            <br>
