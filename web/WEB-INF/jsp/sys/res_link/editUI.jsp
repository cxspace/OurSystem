...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post" action="${pageContext.request.contextPath}/system_res_link_edit.action">

            <s:hidden value="%{resLink.time}" name="resLink.time"></s:hidden>

            <s:hidden value="%{resLink.create_person}" name="resLink.create_person"></s:hidden>

            <s:hidden value="%{resLink.id}" name="resLink.id"></s:hidden>

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">资料链接名</label>

                <div class="col-sm-5">
                    <input type="text" class="form-control" name="resLink.name" value="<s:property value="resLink.name"></s:property>" id="field-1">
                </div>
            </div>
            ...
            <label class="control-label">资料链接内容</label>

            <br><br>

            <textarea id="editor" name="resLink.content" style="width: 100%;height: 360px;">
                <s:property value="resLink.content"></s:property>
            </textarea>
