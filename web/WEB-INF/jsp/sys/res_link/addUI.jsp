...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" action="${pageContext.request.contextPath}/system_res_link_add.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">资料链接名</label>

                <div class="col-sm-5">
                    <input type="text" class="form-control" name="resLink.name" id="field-1" placeholder="请输入资料链接名">
                </div>
            </div>
            ...
            <textarea name="resLink.content" id="editor" style="width: 100%;height: 360px;">
