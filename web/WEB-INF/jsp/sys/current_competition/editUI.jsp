...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" name="form1" method="post" action="${pageContext.request.contextPath}/system_current_competition_edit.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">赛事全名</label>

                <div class="col-sm-5">
                    <input type="text" class="form-control" name="currentCompetition.name" value="<s:property value="currentCompetition.name"></s:property>" id="field-1">
                </div>
            </div>

            <br>

            <label class="control-label">赛事详细内容</label>

            <br><br>

            <textarea id="editor" name="currentCompetition.content" style="width: 100%;height: 360px;">
                <s:property value="currentCompetition.content"></s:property>
            </textarea>

            <s:hidden value="%{currentCompetition.id}" name="currentCompetition.id"></s:hidden>
