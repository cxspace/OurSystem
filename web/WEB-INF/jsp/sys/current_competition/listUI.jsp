...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDelete(id) {
            ...
            document.forms[0].action="${pageContext.request.contextPath}/system_current_competition_delete.action?currentCompetition.id="+id;
            document.forms[0].submit();
        }

        function doEdit(id) {
            document.forms[0].action="${pageContext.request.contextPath}/system_current_competition_editUI.action?currentCompetition.id="+id;
            document.forms[0].submit();
        }

        function doDeleteAll() {
            document.forms[0].action="${pageContext.request.contextPath}/system_current_competition_deleteSelected.action";
            document.forms[0].submit();
        }
        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <tr>
                ...
                <th>
                    ...
                    <a href="${pageContext.request.contextPath}/system_current_competition_addUI.action" class="btn btn-info btn-sm btn-icon icon-left">
