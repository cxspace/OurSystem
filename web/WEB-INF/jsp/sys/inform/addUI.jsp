...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" method="post" class="form-horizontal form-groups-bordered" action="${pageContext.request.contextPath}/system_inform_add.action" enctype="multipart/form-data">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">通知公告标题</label>

                <div class="col-sm-5">
                    <input type="text" class="form-control" id="field-1" name="inform.title" placeholder="请输入通知公告标题">
                </div>
            </div>
            ...
            <%--用struts标签创建时间--%>
            <s:date name="inform.createTime" format="yyyy_MM_dd HH:mm"></s:date>

            <s:hidden name="inform.createTime"></s:hidden>


            <%--默认状态为发布--%>
            <s:hidden name="inform.state" value="1"/>
