...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDelete(id) {
            ...
            document.forms[0].action="${pageContext.request.contextPath}/system_experience_delete.action?experience.id="+id;
            document.forms[0].submit();
        }

        function doEdit(id) {
            document.forms[0].action="${pageContext.request.contextPath}/system_experience_editUI.action?experience.id="+id;
            document.forms[0].submit();
        }

        function doDeleteAll() {
            document.forms[0].action="${pageContext.request.contextPath}/system_experience_deleteSelected.action";
            document.forms[0].submit();
        }
    ...
    <div class="main-content">
        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <tr>
                ...
                <th>
                    ...
                    <a href="${pageContext.request.contextPath}/system_experience_addUI.action" class="btn btn-info btn-sm btn-icon icon-left">
        ...
        <script type="text/javascript">
            ...
            function doGoPage(pageNo) {
                document.forms[0].action = "${pageContext.request.contextPath}/system_experience_listUI.action?pageNo="+pageNo;
                document.forms[0].submit();
            }
