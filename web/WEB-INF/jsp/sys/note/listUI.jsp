...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDelete(id) {
            ...
            document.forms[0].action="${pageContext.request.contextPath}/system_note_delete.action?note.id="+id;
            document.forms[0].submit();
        }

        function doEdit(id) {
            document.forms[0].action="${pageContext.request.contextPath}/system_note_editUI.action?note.id="+id;
            document.forms[0].submit();
        }

        function doDeleteAll() {
            document.forms[0].action="${pageContext.request.contextPath}/system_note_deleteSelected.action";
            document.forms[0].submit();
        }
    ...
    <div class="main-content">
        ...
        <script type="text/javascript">
            ...
            function doGoPage(pageNo) {
                document.forms[0].action = "${pageContext.request.contextPath}/system_note_listUI.action?pageNo="+pageNo;
                document.forms[0].submit();
            }
