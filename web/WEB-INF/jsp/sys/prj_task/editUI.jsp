...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" action="${pageContext.request.contextPath}/system_prj_task_edit.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">任务名</label>

                <div class="col-sm-5">
                    <input type="text" class="form-control" name="prjTask.name" value="<s:property value="prjTask.name"></s:property>" id="field-1">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control datepicker"  name="prjTask.createTime" value="<s:property value="prjTask.createTime"></s:property>" data-start-view="2" readonly>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control datepicker" name="prjTask.deadline" value="<s:property value="prjTask.deadline"></s:property>" data-start-view="2" readonly>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="number" class="form-control" name="prjTask.score" value="<s:property value="prjTask.score"></s:property>">
                </div>
            </div>
            ...
            <textarea name="prjTask.content" id="editor" style="width: 100%;height: 360px">
                <s:property value="prjTask.content"></s:property>
            </textarea>



            <s:hidden value="%{prjTask.id}" name="prjTask.id"></s:hidden>
