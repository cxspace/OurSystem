...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" method="post" class="form-horizontal form-groups-bordered" enctype="multipart/form-data" action="${pageContext.request.contextPath}/system_user_add.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">用户名</label>

                <div class="col-sm-5">
                    <input type="text" class="form-control" id="field-1" name="user.user_name" placeholder="请输入用户名">
                </div>
            </div>

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">上传头像</label>

                <div class="col-sm-5">
                    <input type="file" class="form-control" name="headImg" id="field-9">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="user.account" placeholder="请输入账号">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="user.email" placeholder="请输入邮箱号">
                </div>
            </div>
            ...
            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">电话</label>

                <div class="col-sm-5">
                    <input type="text" class="form-control" name="user.phone" placeholder="请输入电话号">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-offset-5 col-sm-5">
                    ...
                    <button class="btn btn-default" onclick="doSubmit()">添加</button>
