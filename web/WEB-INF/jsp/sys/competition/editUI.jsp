...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post" action="${pageContext.request.contextPath}/system_competition_edit.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">赛事全名</label>

                <div class="col-sm-5">
                    <input type="text" name="competition.name" value="<s:property value="competition.name"></s:property>" class="form-control" id="field-1">
                </div>
            </div>

            <br>

            <label class="control-label">赛事详细介绍</label>

            <br><br>

            <textarea id="editor" name="competition.content" style="width: 100%;height: 360px;">
                <s:property value="competition.content"></s:property>
            </textarea>

            <s:hidden value="%{competition.id}" name="competition.id"></s:hidden>
