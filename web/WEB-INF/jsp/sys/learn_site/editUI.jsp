...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" action="${pageContext.request.contextPath}/system_learn_site_edit.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">站点名</label>
            ...
            <label class="control-label">站点链接和介绍</label>

            <br><br>

            <textarea id="editor" name="learnSite.content" style="width: 100%;height: 360px;">
                <s:property value="learnSite.content"></s:property>
            </textarea>


            <s:hidden value="%{learnSite.id}" name="learnSite.id"></s:hidden>
