...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" action="${pageContext.request.contextPath}/system_learn_site_add.action" method="post">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">站点名</label>

                <div class="col-sm-5">
                    <input type="text" name="learnSite.name" class="form-control" id="field-1" placeholder="请输入站点名">
                </div>
            </div>
