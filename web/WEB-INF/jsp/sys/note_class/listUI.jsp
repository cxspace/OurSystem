...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDelete(id) {
            ...
            document.forms[0].action="${pageContext.request.contextPath}/system_note_class_delete.action?noteClass.id="+id;
            document.forms[0].submit();
        }

        function doEdit(id) {
            document.forms[0].action="${pageContext.request.contextPath}/system_note_class_editUI.action?noteClass.id="+id;
            document.forms[0].submit();
        }

        function doDeleteAll() {
            document.forms[0].action="${pageContext.request.contextPath}/system_note_class_deleteSelected.action";
            document.forms[0].submit();
        }
        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <tr>
                ...
                <th>
                    ...
                    <a href="${pageContext.request.contextPath}/system_note_class_addUI.action" class="btn btn-info btn-sm btn-icon icon-left">
            ...
            <s:iterator value="noteClassList" status="st">

            <tr>
                <td>
                    <div class="checkbox checkbox-replace">
                        <input type="checkbox" id="chk-3" name="selectedRow" value="<s:property value="id"></s:property>">
                    </div>
                </td>
                <td>
