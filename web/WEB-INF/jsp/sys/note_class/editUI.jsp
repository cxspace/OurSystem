...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post" action="${pageContext.request.contextPath}/system_note_class_edit.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">笔记类别名</label>

                <div class="col-sm-5">
                    <input type="text" name="noteClass.name" value="<s:property value="noteClass.name"></s:property>" class="form-control" id="field-1">
                </div>
            </div>

            <s:hidden value="%{noteClass.id}" name="noteClass.id"></s:hidden>
