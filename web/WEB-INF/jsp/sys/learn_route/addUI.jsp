...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post" action="${pageContext.request.contextPath}/system_learn_route_add.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">路线名</label>

                <div class="col-sm-5">
                    <input type="text" class="form-control" id="field-1" name="learnRoute.name" placeholder="请输入路线名">
                </div>
            </div>
