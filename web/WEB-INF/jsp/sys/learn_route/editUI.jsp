...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" action="${pageContext.request.contextPath}/system_learn_route_edit.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">路线名</label>

                <div class="col-sm-5">
                    <input type="text" name="learnRoute.name" value="<s:property value="learnRoute.name"></s:property>" class="form-control" id="field-1" >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" name="learnRoute.time" value="<s:property value="learnRoute.time"></s:property>" class="form-control datepicker" data-start-view="2">
                </div>
            </div>
            ...
            <label class="control-label">路线内容</label>

            <br><br>

            <textarea id="editor" name="learnRoute.content" style="width: 100%;height: 660px;">
                <s:property value="learnRoute.content"></s:property>
            </textarea>

            <s:hidden value="%{learnRoute.id}" name="learnRoute.id"></s:hidden>
